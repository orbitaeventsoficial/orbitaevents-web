...
export const MASTER_ATLAS_MODULES: MasterAtlasModuleDefinition[] = [
  ...
  },
  {
    ...
    operations: ['Veure accions pendents', 'Enviar email post-event amb enquesta', 'Crear esborrany social revisable', 'Crear draft de portfolio des d informe completat', 'Demanar ressenya', 'Crear testimoni', 'Generar referral'],
    risks: ['Enviar massa aviat o sense context', 'Barrejar informe intern amb missatge al client', 'Mirar ClientFeedback com a estat del post-event', 'Publicar esborrany social sense revisió', 'Publicar portfolio sense media marcada ni revisió', 'No tancar el loop a la home'],
    safeTouch: ['Primer lectura interna', 'Després esborrany', 'Social sempre DRAFT_NOT_PUBLISHED fins revisió', 'Portfolio sempre draft fins revisió', 'Finalment auto-dispatch amb autorització', 'Separar report intern de copy client'],
    validations: ['post-event tests', 'portfolioEventService tests', 'post-event portfolio API tests', 'postEventRecurrenceDecisionService tests', 'socialPostService review gate tests', 'captura /admin/post-event', 'test dispatch si toca enviament', 'validate:core'],
    nextMoves: [
      { label: 'Auto-esborrany post-event amb revisió', why: 'El playbook ja crea/reutilitza SocialPost DRAFT i l obre al workspace amb guard de revisió abans de publicar (#1996).', impact: 'ALT', effort: 'MITJA', status: 'FET' },
      { label: 'Portfolio/testimoni des de bolo completat', why: 'El report completat ja pot crear/reutilitzar PortfolioEvent DRAFT des de /admin/post-event/reports, exigint media marcada i obrint revisió a /admin/portfolio (#1997).', impact: 'ALT', effort: 'ALT', status: 'FET' },
    ],
  },
  {
    id: 'cataleg',
