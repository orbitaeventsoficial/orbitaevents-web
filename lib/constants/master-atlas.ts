...
export const MASTER_ATLAS_MODULES: MasterAtlasModuleDefinition[] = [
  {
    ...
    electricPatterns: ['app/admin/page.tsx', 'app/admin/control', 'dailyBriefService', 'dashboard-data', 'operationalPulse', 'economicCockpit', 'capacityConflict'],
    sourceOfTruth: ['dailyBriefService', 'dashboard-data', 'capacityConflictService', 'leadPriorityService', 'postEventPlaybookService', 'economicCockpit'],
    docs: ['docs/TESI-MAQUINA-full-de-ruta-2026-07.md', 'docs/TESI-ZENIT-MAQUINA-ORBITA-2026-07-04.md', 'docs/admin-protocol.md'],
    operations: ['Llegir tasques i alertes', 'Triar leads del dia', 'Detectar post-event pendent', 'Veure xocs de capacitat i caixa'],
    risks: ['Tornar a fer un dashboard immens', 'Duplicar KPIs que ja calcula dashboard-data', 'Fer que el propietari hagi d obrir massa pantalles'],
    ...
    nextMoves: [
      ...
      { label: 'Regla de dissabte/capacitat abans d acceptar', why: 'Evita compromisos impossibles abans que entrin al calendari.', impact: 'ALT', effort: 'MITJA', status: 'PENDENT' },
    ],
  },
  {
    id: 'comercial',
  ...
  },
  {
    ...
    electricPatterns: ['bookingCreationService', 'bookingRouteService', 'BookingServiceLine', 'bookingChecklistService', 'bookingInventoryService', 'capacityConflict', 'crewSchedule', 'onBookingConfirmed'],
    sourceOfTruth: ['Booking', 'BookingServiceLine', 'bookingCreationService', 'bookingRouteService', 'bookingChecklistService', 'capacityConflictService'],
    docs: ['docs/admin-fitxes-pantalles.md', 'docs/protocol-executiu.md'],
    operations: ['Crear reserva', 'Copiar service lines del lead', 'Confirmar checklist', 'Assignar inventari', 'Veure calendari/cuadrant'],
    risks: ['Comprometre dos bolos el mateix dia', 'Editar reserva com si encara fos lead', 'No crear checklist pre-event', 'Trencar customerId en vistes filtrades'],
    ...
    nextMoves: [
      { label: 'Guard proactiu de dissabtes/capacitat', why: 'Evita errors cars abans d acceptar o preparar el bolo.', impact: 'ALT', effort: 'MITJA', status: 'PENDENT' },
