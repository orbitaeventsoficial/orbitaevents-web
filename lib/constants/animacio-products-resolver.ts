...
import { ANIMACIO_PRODUCTS_STRUCTURE, ANIMACIO_PRODUCT_IDS, type AnimacioProduct } from './animacio-products';
...
export async function getAnimacioProducts(locale = 'ca'): Promise<AnimacioProduct[]> {
  ...
  return ANIMACIO_PRODUCT_IDS.map((id) => {
    ...
    return {
      ...
      trams: 'trams' in structure ? [...structure.trams] : undefined,
      djOptions: 'djOptions' in structure ? [...structure.djOptions] : undefined,
