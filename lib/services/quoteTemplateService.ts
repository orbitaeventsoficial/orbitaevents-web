...
function sanitizeEmail(value: unknown): string {
  ...
  return email || DEFAULT_QUOTE_TEMPLATE.adminCopyEmail;
}
...
export function normalizeQuoteTemplate(input: unknown): QuoteTemplateSettings {
  ...
  return {
    ...
    sendAdminCopy:
      typeof raw.sendAdminCopy === 'boolean'
        ? raw.sendAdminCopy
        : DEFAULT_QUOTE_TEMPLATE.sendAdminCopy,
...
export async function upsertQuoteTemplateSettings(
