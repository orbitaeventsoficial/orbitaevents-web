 ...
 * ======================
 * Gestiona plantilles email editables des de la BD.
 * Fallback a plantilles per defecte hardcoded si no n'hi ha a la BD.
 */
...
// Definició de plantilles disponibles
...
// Variables disponibles per cada plantilla
export const TEMPLATE_VARIABLES: Record<TemplateSlug, string[]> = {
...
/**
 * Interpolar variables dins d'un template string
 * Suporta {{variableName}} com a patró
 */
...
/**
 * Obtenir una plantilla resoluta (BD o default)
 */
export async function getTemplate(
  ...
  try {
    ...
    // Fallback a default si la BD falla
  }
...
/**
 * Llistar totes les plantilles (BD + defaults)
 */
...
// ═══════════════════════════════════════════════════════════════════════════
// PLANTILLES PER DEFECTE — disseny professional Òrbita
// ═══════════════════════════════════════════════════════════════════════════
...
📞 623 15 28 60 · ✉ info@orbitaevents.com · 🌐 orbitaevents.com
</div>
<div style="margin-top:12px;font-size:11px;color:rgba(255,255,255,0.2);">
© ${new Date().getFullYear()} Òrbita Events · Granollers, Barcelona
</div>
</td></tr>
...
`) },
      en: { subject: 'We received your testimonial — Thank you {{clientName}}!', bodyHtml: emailShell(`
...
${ctaButton('Dejar reseña ⭐', '{{reviewUrl}}')}
`) },
      en: { subject: '{{clientName}}, we\'d love your feedback! ⭐', bodyHtml: emailShell(`
...
`) },
      en: { subject: 'Welcome to Òrbita Events! 🎵', bodyHtml: emailShell(`
