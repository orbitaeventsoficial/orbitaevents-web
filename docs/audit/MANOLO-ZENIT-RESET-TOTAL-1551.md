...
1. **E2E lead -> dossier -> reserva.** Reproduir un lead real amb productes, desplaçament, peatges, dietes, imatges i pacte partner; #1733 blinda `hours`/`partyType`, #1734 blinda km/peatges en seleccionar lead dins del generador, #1735 blinda peatges en snapshots antics, #1736 alinea PDF compost amb email/HTML, #1738 explica el pacte partner, #1739 arregla previews blob amb imatges, #1740 ordena jerarquia/imatges responsives, #1741 alinea vehicle client amb liquidació de ruta llarga i #1743 conserva la liquidació oculta de ruta en crear reserva. Falta verificar el cas complet fins a dossier final amb imatges.
