...
| V5 | CATÀLEG → PREU | Pack/Inventari→Cost→Preu recomanat→Pressupost (cablejat de preus) | 🔶 EN CURS #1275 |
...
- 🔶 **V5-#15 · So Isma s'afegia a bolos sense pack de catàleg — RESOLT #1275** — `bookingCreationService` només afegeix la línia automàtica de so quan el `packId` original és un pack real de catàleg, no el pack tècnic `__custom__`.
