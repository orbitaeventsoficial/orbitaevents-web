      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
          {reviews.map((review, index) => (
            <div
              key={index}
              className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 border border-white/10 hover:border-amber-500/30 active:border-amber-500/40 transition-all duration-300 group"
            >
              {/* Quote Icon */}
              ...
              {/* Text */}
              <p className="text-slate-300 text-sm md:text-sm leading-relaxed line-clamp-4" style={{ lineHeight: '1.7' }}>
                {review.text}
              </p>
        ...
        {showGoogleButton && googleUrl && (
          <div className="text-center mt-10 md:mt-12 px-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-5 md:py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-black font-bold rounded-full hover:from-amber-400 hover:to-amber-500 active:scale-95 transition-all shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 min-h-[56px] touch-manipulation"
            >
