...
(async () => {
  const outDir = 'D:/orbitaevents/.codex-captures/mobile-fix-2026-04-03-v4';
  ...
  await page.screenshot({ path: path.join(outDir, 'home-mobile-intro-mid.png'), fullPage: false });
