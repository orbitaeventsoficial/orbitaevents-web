...
(async () => {
  ...
  const routes = [
    { name: 'mobile-servicios-postfix', url: 'http://localhost:3000/ca/servicios', wait: 2600 },
    { name: 'mobile-packs-postfix', url: 'http://localhost:3000/ca/packs', wait: 2400 },
    { name: 'mobile-portfolio-postfix', url: 'http://localhost:3000/ca/portfolio', wait: 2400 },
  ];
