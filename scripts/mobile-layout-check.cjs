...
(async () => {
  ...
  const routes = [
    { name: 'mobile-servicios-check', url: 'http://localhost:3000/ca/servicios', wait: 2600 },
    { name: 'mobile-packs-check', url: 'http://localhost:3000/ca/packs', wait: 2400 },
    { name: 'mobile-portfolio-check', url: 'http://localhost:3000/ca/portfolio', wait: 2400 },
    { name: 'mobile-home-check', url: 'http://localhost:3000/ca', wait: 2800 },
  ];
