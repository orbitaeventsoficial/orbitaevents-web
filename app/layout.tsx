...
import { inter, plusJakarta, cormorant, bricolage, plexMono, manrope } from '@/app/fonts';
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html
      lang="ca"
      className={`${inter.variable} ${plusJakarta.variable} ${cormorant.variable} ${bricolage.variable} ${plexMono.variable} ${manrope.variable} scroll-smooth`}
