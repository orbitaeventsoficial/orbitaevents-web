...
const PACKS: PackDefinition[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "configurator.step2.packs.bodas-luxury.features.f5",
      "configurator.step2.packs.bodas-luxury.features.f6",
    ],
    ideal: "configurator.step2.packs.bodas-luxury.ideal",
    duration: "6h",
    durationHours: 6,
    capacidadMinima: 100,
    capacidadMaxima: 300,
  ...
  },
  {
    ...
    priceValue: 400,
    features: [
      "services.mobile.discoPacks.disco-completo.features.f1",
      "services.mobile.discoPacks.disco-completo.features.f2",
      "services.mobile.discoPacks.disco-completo.features.f3",
      "services.mobile.discoPacks.disco-completo.features.f4",
      "services.mobile.discoPacks.disco-completo.features.f5",
    ],
  ...
  },
  {
    ...
    emotion: "configurator.step2.packs.empresas-evento.tagline",
    price: "400€",
    priceValue: 400,
    features: [
    ...
    ideal: "configurator.step2.packs.empresas-evento.ideal",
    duration: "3h",
    durationHours: 3,
    popular: true,
    badge: "packsBadges.mostPopular",
