...
const PACKS: PackDefinition[] = [
  ...
  // =============================================
  {
    ...
    service: "fiestas",
    slug: "oferta-flash",
    i18nBaseKey: "pages.parties.discoPacks.oferta-flash",
    name: "pages.parties.discoPacks.oferta-flash.name",
    tagline: "pages.parties.discoPacks.oferta-flash.tagline",
    price: "250€",
    priceValue: 250,
    priceOriginal: "450€",
    priceOriginalValue: 450,
    features: [
      "pages.parties.discoPacks.oferta-flash.features.0",
      "pages.parties.discoPacks.oferta-flash.features.1",
      "pages.parties.discoPacks.oferta-flash.features.2",
      "pages.parties.discoPacks.oferta-flash.features.3",
      "pages.parties.discoPacks.oferta-flash.features.4",
    ],
    ideal: "pages.parties.discoPacks.oferta-flash.ideal",
  ...
  // =============================================
  {
    ...
    service: "discomovil",
    slug: "party-starter",
    i18nBaseKey: "pages.parties.discoPacks.disco-basico",
    name: "pages.parties.discoPacks.disco-basico.name",
    tagline: "pages.parties.discoPacks.disco-basico.tagline",
    emotion: "pages.parties.discoPacks.disco-basico.tagline",
    price: "350€",
    priceValue: 350,
    features: [
      "pages.parties.discoPacks.disco-basico.features.0",
      "pages.parties.discoPacks.disco-basico.features.1",
      "pages.parties.discoPacks.disco-basico.features.2",
      "pages.parties.discoPacks.disco-basico.features.3",
      "pages.parties.discoPacks.disco-basico.features.4",
    ],
    ideal: "pages.parties.discoPacks.disco-basico.ideal",
    duration: "3 horas",
    durationHours: 3,
    badge: "Básico",
    capacidadMinima: 20,
  ...
  },
  {
    ...
    service: "discomovil",
    slug: "party-machine",
    i18nBaseKey: "pages.parties.discoPacks.disco-completo",
    name: "pages.parties.discoPacks.disco-completo.name",
    tagline: "pages.parties.discoPacks.disco-completo.tagline",
    price: "400€",
    priceValue: 400,
    features: [
      "pages.parties.discoPacks.disco-completo.features.0",
      "pages.parties.discoPacks.disco-completo.features.1",
      "pages.parties.discoPacks.disco-completo.features.2",
      "pages.parties.discoPacks.disco-completo.features.3",
      "pages.parties.discoPacks.disco-completo.features.4",
    ],
    ideal: "pages.parties.discoPacks.disco-completo.ideal",
    duration: "4 horas",
    durationHours: 4,
    popular: true,
    badge: "Más popular",
  ...
  },
  {
    ...
    service: "discomovil",
    slug: "vip-experience",
    i18nBaseKey: "pages.parties.discoPacks.disco-premium",
    name: "pages.parties.discoPacks.disco-premium.name",
    tagline: "pages.parties.discoPacks.disco-premium.tagline",
    price: "700€",
    priceValue: 700,
    features: [
      "pages.parties.discoPacks.disco-premium.features.0",
      "pages.parties.discoPacks.disco-premium.features.1",
      "pages.parties.discoPacks.disco-premium.features.2",
      "pages.parties.discoPacks.disco-premium.features.3",
      "pages.parties.discoPacks.disco-premium.features.4",
    ],
    ideal: "pages.parties.discoPacks.disco-premium.ideal",
    duration: "6 horas",
    durationHours: 6,
    badge: "Premium",
    capacidadMinima: 80,
