...
import { CLIENT_PORTAL_MESSAGES, CLIENT_PORTAL_STATUS_LABELS, type ClientPortalLocale } from '@/lib/clientPortalMessages';
...
export default async function ClientPortalPage({
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-black via-bg-main to-black text-white/90 relative">
