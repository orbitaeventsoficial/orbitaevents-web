...
export const metadata: Metadata = {
  title: '¡Gracias por tu solicitud! | Òrbita Events',
  description: 'Hemos recibido tu solicitud. Te responderemos en menos de 2 horas.',
  robots: { index: false, follow: false }, // No indexar página de gracias
};
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-white">Respuesta rápida</h3>
            </div>
            <p className="text-white/60 text-sm">
              Te responderemos en <strong className="text-amber-400">menos de 2 horas</strong> (horario laboral)
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-white">¿Urgente?</h3>
            </div>
            <a
        ...
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10 mb-8">
          ...
          <ul className="space-y-3 text-white/60 text-sm">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Te contactaremos para confirmar fecha, ubicación y detalles</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-emerald-400 font-bold">3.</span>
              <span>Te enviaremos un presupuesto personalizado</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-emerald-400 font-bold">4.</span>
              <span>Si te convence, reservamos tu fecha con una señal del 30%</span>
            </li>
          </ul>
        </div>
