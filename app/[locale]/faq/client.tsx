...
export default function FAQClient({
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* Categories Tabs */}
      <section className="sticky top-16 z-20 bg-black/90 backdrop-blur-sm border-b border-white/10 py-4">
      ...
      {/* CTA */}
      <section className="py-16 px-4 bg-gradient-to-b from-transparent to-amber-500/5">
          ...
          >
            ...
            <a
              href={`https://wa.me/34699121023?text=${encodeURIComponent(
                locale === 'es'
                  ? 'Hola! Tengo una pregunta sobre vuestros servicios'
                  : 'Hola! Tinc una pregunta sobre els vostres serveis'
              )}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 bg-green-600 hover:bg-green-500 text-white font-bold rounded-full transition-all hover:scale-105"
            >
