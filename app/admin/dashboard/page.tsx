  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="p-4 grid grid-cols-2 gap-4">
            <div className="text-center p-4 bg-slate-50 rounded-lg">
              <p className="text-3xl font-bold text-slate-900">{data.leads.total}</p>
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-200 p-4 flex items-center justify-between">
            <h3 className="font-semibold text-slate-900">Reserves</h3>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-slate-900">Inventari</h3>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-slate-900">{data.inventory.available}</p>
            ...
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-slate-900">{data.inventory.inUse}</p>
            ...
            <div className="text-center">
              ...
              <p className="text-2xl font-bold text-slate-900">{data.inventory.maintenance}</p>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-200 p-4">
            <h3 className="font-semibold text-slate-900">Pròxims Events</h3>
          </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-200 p-4">
            <h3 className="font-semibold text-slate-900">Últims Leads</h3>
          </div>
          <div className="divide-y divide-slate-100">
