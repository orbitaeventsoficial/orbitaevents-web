  ...
  return (
    <div className="space-y-6">
      <header className="rounded-2xl border border-slate-700/60 bg-slate-900/70 p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-slate-100">Sales Ops</h1>
        <p className="mt-1 text-sm text-slate-300">
          Forecast, conversió per canal/comercial i automatització SLA.
        </p>
      </header>
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        ...
        <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4 shadow-sm">
          <p className="text-xs text-amber-300">SLA NEW trencat (+24h)</p>
      ...
      <section className="rounded-2xl border border-slate-700/60 bg-slate-900/70 p-5 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="text-lg font-semibold text-slate-100">Automatització SLA</h2>
            <p className="text-sm text-slate-300">
              Crea tasca automàtica i eleva prioritat en leads NEW fora de SLA.
            </p>
          </div>
