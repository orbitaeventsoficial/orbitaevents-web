    ...
    <div className="space-y-6">
            ...
            {upcomingBookings.length > 0 ? (
              <div className="divide-y divide-white/5">
                {upcomingBookings.map((booking) => (
                  <div key={booking.id} className="px-6 py-4 flex items-center justify-between hover:bg-slate-100 transition-colors">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-black font-medium">{booking.clientName || 'Client'}</p>
        ...
        {recentLeads.length > 0 ? (
          <div className="divide-y divide-white/5">
            {recentLeads.map((lead) => (
              <div key={lead.id} className="px-6 py-4 flex items-center justify-between hover:bg-slate-100 transition-colors">
                <div className="flex items-center gap-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 rounded-xl bg-gradient-to-br from-green-500/10 to-green-600/5 border border-green-500/20">
          ...
          <p className="text-2xl font-bold text-black mt-1">{conversionRate}%</p>
        ...
        <div className="p-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/20">
          ...
          <p className="text-2xl font-bold text-black mt-1">{testimonialsApproved + testimonialsPending}</p>
        ...
        <div className="p-4 rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/20">
          ...
          <p className="text-2xl font-bold text-black mt-1">⭐ {rating}</p>
        ...
        <div className="p-4 rounded-xl bg-gradient-to-br from-orange-500/10 to-orange-600/5 border border-orange-500/20">
          ...
          <p className="text-2xl font-bold text-black mt-1">{inventoryActive}/{inventoryTotal}</p>
