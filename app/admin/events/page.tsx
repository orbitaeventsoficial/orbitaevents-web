        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div>
            <input
              ...
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-amber-500/50"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-4 text-sm">
            <span className="text-gray-400">
              Total: <span className="text-white font-semibold">{filteredBookings.length}</span>
            </span>
                  ...
                  <div className="ml-4">
                    {!booking.post_event_sent_at ? (
                      ...
                      <button
                        onClick={() => sendPostEvent(booking)}
                        disabled={sending === booking.id}
                        className="px-4 py-2 bg-white/5 text-gray-400 rounded-lg hover:bg-white/10 transition-all border border-white/10"
                      >
                        🔄 Re-enviar
                      </button>
                    )}
