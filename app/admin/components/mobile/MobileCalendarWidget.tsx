            ...
            <div className="space-y-2">
              {events.map((event) => (
                <Link
                  ...
                  className="flex items-center gap-3 p-3 bg-stone-100 rounded-xl active:bg-stone-100 transition-colors"
                >
...
export default function MobileCalendarWidget({ fullPage = false }: { fullPage?: boolean }) {
  ...
  return (
    <div className={containerClass}>
      {fullPage && (
        <h1 className="text-2xl font-bold text-slate-700 mb-6">Calendari</h1>
      )}
      ...
      {/* Loading overlay */}
      {isLoading && (
        <div className="absolute inset-0 bg-stone-100/70 flex items-center justify-center rounded-2xl">
          <motion.div
