...
export function MetricCard({ icon, label, value, change, changeType, className = '' }: MetricCardProps) {
  return (
    <div className={`
      ...
      bg-[#141414] rounded-2xl border border-stone-200
      p-6 group hover:border-stone-200 
...
export function Badge({ label, color = 'gray', size = 'md', icon }: BadgeProps) {
  const colors = {
    ...
    gray: 'bg-stone-100 text-neutral-400 border-stone-200',
  };
  ...
  return (
    <>
      ...
      <div className={`
        ...
        bg-[#141414] border-l border-stone-200
