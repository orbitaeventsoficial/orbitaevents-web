        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Link
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 bg-white/10 backdrop-blur text-white font-bold rounded-full border border-white/20 hover:bg-white/20 hover:scale-105 transition-all"
            >
              📞 {t('call')}
            </Link>
