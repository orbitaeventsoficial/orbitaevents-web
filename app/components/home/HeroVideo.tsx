...
const getStatsData = (totalEvents: number): StatData[] => [
  { value: totalEvents, suffix: '+', labelKey: 'eventsRealized' },
  ...STATIC_STATS,
];
...
export default function HeroVideo() {
  const t = useTranslations('homeSections.heroVideo');
  const tStats = useTranslations('homeSections.heroStats');
  ...
  const scale = useTransform(scrollY, [0, 200, 800], [1, 1, 1.1]);
  const y = useTransform(scrollY, [0, 800], [0, 150]);
  const contentY = useTransform(scrollY, [0, 200, 600], [0, 0, -50]);
  const contentOpacity = useTransform(scrollY, [0, 300, 600], [1, 1, 0]);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <span className="flex items-center gap-1">
              <span className="text-green-400">✓</span> {t('trust1')}
            </span>
            <span className="flex items-center gap-1">
              <span className="text-green-400">✓</span> {t('trust2')}
            </span>
            <span className="flex items-center gap-1">
              <span className="text-green-400">✓</span> {t('trust3')}
            </span>
          </motion.div>
