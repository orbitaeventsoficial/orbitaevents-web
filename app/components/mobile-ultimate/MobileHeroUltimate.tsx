  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-[100svh] items-end px-5 pb-16 pt-24">
        <div className="mx-auto w-full max-w-md rounded-[32px] border border-white/8 bg-[linear-gradient(180deg,rgba(18,18,18,0.30),rgba(8,8,8,0.18))] px-4 py-5 shadow-[0_24px_72px_rgba(0,0,0,0.34)] backdrop-blur-[18px]">
          <motion.div
          ...
          >
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-[1.2rem] bg-gradient-to-r from-amber-100 via-amber-300 to-orange-200 px-5 py-3.25 text-sm font-black text-black shadow-[0_12px_28px_rgba(251,191,36,0.18)]"
            >
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <Link
                ...
                className="flex items-center justify-center rounded-[1.1rem] border border-white/10 bg-white/[0.055] px-4 py-2.75 text-sm font-semibold text-white/80"
              >
                {t('ctaPacks')}
              </Link>
              <Link
                ...
                className="flex items-center justify-center rounded-[1.1rem] border border-white/10 bg-white/[0.028] px-4 py-2.75 text-sm font-semibold text-white/68"
              >
          ...
          <motion.div
            ...
            className="mt-5 flex flex-wrap gap-2 text-[11px] text-white/50"
          >
            <span className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5">{t('location')}</span>
            <span className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5">{t('socialProof')}</span>
          </motion.div>
        </div>
      </div>
    </section>
