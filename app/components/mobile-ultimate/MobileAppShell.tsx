  ...
  return (
    <AnimatePresence>
      {isVisible && scrollProgress > 0.1 && (
        ...
        >
          <div className="mx-3 mt-2 px-4 py-2.5 bg-zinc-950/85 backdrop-blur-2xl rounded-2xl border border-white/[0.10] shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <div className="flex items-center justify-between">
              {/* Logo */}
              <a href={`/${locale}`} className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-amber-300 to-orange-500 flex items-center justify-center shadow-[0_4px_12px_rgba(251,191,36,0.25)]">
                  <span className="text-black font-black text-xs">Ò</span>
                </div>
                <span className="text-white/90 font-bold text-sm">Òrbita</span>
              </a>
              ...
              <motion.a
                href={WHATSAPP_URL}
                whileTap={{ scale: 0.93 }}
                className="flex items-center gap-1.5 px-3.5 py-1.5 bg-gradient-to-r from-amber-400 to-orange-500 rounded-xl shadow-[0_4px_16px_rgba(251,191,36,0.25)]"
              >
                ...
                <span className="text-black font-black text-xs">{t('buttons.whatsapp')}</span>
              </motion.a>
            </div>
          </div>
        </motion.header>
