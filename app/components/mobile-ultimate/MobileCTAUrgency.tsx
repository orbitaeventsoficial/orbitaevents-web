        ...
        <div className="relative">
          ...
          <div className="space-y-2 mb-8">
            ...
            <motion.a
              ...
              className="flex items-center justify-center gap-2.5 py-3 px-5 bg-white/8 backdrop-blur-md rounded-xl border border-white/15 font-semibold text-white text-sm"
            >
