...
const STEPS = [
  {
    ...
    desc: "Contacta'ns per WhatsApp o configura el teu pressupost online. T'escoltem sense cap compromís i en menys de 2h tens resposta.",
  ...
  },
  {
    ...
    desc: 'Creem un pressupost 100% personalitzat per al teu event. Sense sorpreses ni costos ocults. Tot clar des del primer moment.',
  ...
  },
  {
    ...
    desc: "El dia B, l'equip d'Òrbita s'encarrega de cada detall perquè l'event sigui perfecte. Tu, a gaudir del moment.",
    ...
    <section className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          ...
          <p className="text-white/50 text-lg">3 passos · 0 complicacions</p>
        </motion.div>
