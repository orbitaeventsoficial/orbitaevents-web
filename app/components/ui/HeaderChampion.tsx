        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.nav
              ...
              className="absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-zinc-950/95 backdrop-blur-xl border-l border-white/[0.08] shadow-[-24px_0_80px_rgba(0,0,0,0.45)]"
            >
              {/* Ambient glow */}
              <div className="absolute top-20 right-0 w-48 h-48 bg-amber-500/8 rounded-full blur-[80px] pointer-events-none" />

              <div className="flex flex-col h-full pt-20 pb-24 px-5 relative">
                {/* Close hint */}
                ...
                <div className="space-y-2 pt-3 border-t border-white/[0.06]">
                  ...
                  <a
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="flex items-center justify-center gap-2 self-center px-4 py-2.5 bg-white/[0.04] text-white/76 text-[13px] font-medium rounded-xl border border-white/[0.08] active:scale-[0.97] transition-transform"
                  >
