                ...
                {SERVICIOS_LINKS.map((link) => (
                  <li key={link.nameKey}>
                    <Link
                      ...
                      className="text-white/60 hover:text-amber-400 text-sm transition-colors inline-flex items-center gap-2 group py-2 touch-manipulation"
                    >
                      <span className="group-hover:scale-110 transition-transform text-base">
                        {link.icon}
                      </span>
                ...
                {EXPERIENCIAS_LINKS.map((link) => (
                  <li key={link.nameKey}>
                    <Link
                      ...
                      className="text-white/60 hover:text-purple-400 text-sm transition-colors inline-flex items-center gap-2 group py-2 touch-manipulation"
                    >
                      <span className="group-hover:scale-110 transition-transform text-base">
                        {link.icon}
                      </span>
            ...
            <div>
              ...
              <div className="space-y-3">
                <Link
                  ...
                  className="flex items-center justify-center gap-2 w-full px-4 py-4 min-h-[52px] rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-black font-bold text-sm hover:scale-105 active:scale-95 transition-transform shadow-lg shadow-orange-500/25 touch-manipulation"
                >
                ...
                <a
                  href={WHATSAPP_URL}
                  target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full px-4 py-4 min-h-[52px] rounded-xl bg-green-600 hover:bg-green-500 active:bg-green-700 text-white font-bold text-sm transition-colors touch-manipulation"
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-x-2 gap-y-1 text-sm">
              {LEGAL_LINKS.map((link, idx) => (
                <span key={link.nameKey} className="flex items-center gap-2">
                  <Link
                    href={link.href}
                    onClick={() => handleLinkClick('legal', link.nameKey)}
                    className="text-white/60 hover:text-amber-400 transition-colors py-2 px-1 touch-manipulation"
                  >
