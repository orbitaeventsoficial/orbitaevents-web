...
// ═══════════════════════════════════════════════════════════════════════════
// FIX SOLAPAMENT BOTONS
// 
// PROBLEMA: El botó de "Contacta'ns" es solapa amb WhatsApp
// SOLUCIÓ: 
// - Desktop: WhatsApp flotant a la dreta, ben posicionat
// - Mòbil: Bottom bar amb els 2 botons integrats (NO WhatsApp flotant)
// ═══════════════════════════════════════════════════════════════════════════

// ═══════════════════════════════════════════════════════════════════════════
// 1. WHATSAPP DESKTOP ONLY - Només visible a desktop
// ═══════════════════════════════════════════════════════════════════════════
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-8 right-8 z-40 hidden md:block" // NOMÉS DESKTOP
        >
          {/* Tooltip */}
          <AnimatePresence>
            {showTooltip && (
          ...
          >
            ...
            {/* Button */}
            <div className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/20 group-hover:shadow-[#25D366]/40 group-hover:scale-110 transition-all duration-300">
...
// ═══════════════════════════════════════════════════════════════════════════
// 2. BOTTOM BAR MOBILE - Amb els 2 CTAs integrats (sense solapament)
// ═══════════════════════════════════════════════════════════════════════════
          ...
          >
            ...
            <div className="bg-[#0A0A0A]/95 backdrop-blur-xl border-t border-white/[0.06] px-4 py-3">
              <div className="flex gap-3">
                ...
                <Link
                  href="/configurador"
                  className="flex-1 bg-gradient-to-r from-[#C9A962] to-[#A68B4B] text-[#0A0A0A] font-semibold py-3.5 rounded-xl text-center active:scale-[0.98] transition-transform"
                >
                  Pressupost Gratis
                </Link>
                
                {/* WhatsApp - INTEGRAT, NO FLOTANT */}
                <a
                  href="https://wa.me/34699121023?text=Hola! M'agradaria informació"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#25D366] text-white font-semibold py-3.5 px-5 rounded-xl flex items-center justify-center gap-2 active:scale-[0.98] transition-transform"
                >
...
// ═══════════════════════════════════════════════════════════════════════════
// 3. EXPORT COMBINAT - Per usar al layout
// ═══════════════════════════════════════════════════════════════════════════
