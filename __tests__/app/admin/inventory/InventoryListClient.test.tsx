...
describe('InventoryListClient health filters', () => {
  ...
  // El test de «friccions operatives» depenia del panell OwnerControlStrip, eradicat
  // al #976 (ara retorna null). El component encara computa les friccions però ja no
  // les renderitza enlloc, així que no hi ha superfície viva per assertar. Eliminat.
});
