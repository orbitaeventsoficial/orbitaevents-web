...
const { mockRequireAuth, mockSendQuote } = vi.hoisted(() => ({
...
describe('POST /api/admin/emails/quote', () => {
  beforeEach(() => { vi.clearAllMocks(); mockRequireAuth.mockReturnValue(null); mockSendQuote.mockResolvedValue({ status: 200, body: { ok: true } }); });
